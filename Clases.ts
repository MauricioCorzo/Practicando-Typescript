...
class Humano {
    ...
    // Function getter. Nos permite acceder a algo privado o protected
    getEdad() {
...
// Esta clase tiene que tener las propiedades de la interface Persona y Estudiante. Si quiero tener mas de una interfaz se le agrega
// poniendole una "," (coma)
class MezclarInterfaces implements Persona, Estudiante {
    ...
    constructor(nombre: string, apellido: string, edad: number, hobbies: Hobby[], estaActivo: boolean) {
        (this.nombre = nombre), (this.apellido = apellido), (this.edad = edad), (this.hobbies = hobbies), (this.estaActivo = estaActivo);
    }
